...
var addWidgetDialog = function(){
    var dialog = {
        created : function(modal){
            var types = document.getElementsByClassName('widget-add-dialog-type-container__item');
        ...
        typeChange : function(newType) {
            var container = document.getElementById('widget-add-dialog-properties-container');
